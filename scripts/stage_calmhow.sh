...
MY_PC_SRC_URL='http://10.21.250.221/images/ahv/techsummit/5.5-prism_central.tar'
MY_PC_META_URL='http://10.21.250.221/images/ahv/techsummit/5.5-prism_central_metadata.json'
